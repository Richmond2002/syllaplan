...
import { Loader2, User, Mail, Building, BookCopy, Bell, Shield, Languages } from "lucide-react";
...
const assignedCourses = [
  ...
  { code: "CS401", title: "Introduction to Artificial Intelligence" },
  { code: "CS340", title: "Database Systems" },
];

const loginHistory = [
    { date: "2024-07-28 10:30 AM", ip: "192.168.1.1", device: "Chrome on macOS" },
    { date: "2024-07-27 05:15 PM", ip: "10.0.0.5", device: "Safari on iPhone" },
]
...
export default function LecturerProfilePage() {
  ...
  useEffect(() => {
    const unsubscribe = auth.onAuthStateChanged((user) => {
      setUser(user);
      if (user) {
        setDisplayName(user.displayName || "Dr. Samuel Chen");
      }
    });
    return () => unsubscribe();
  }, [auth]);
        ...
        <div className="md:col-span-1">
            <Card>
                <CardContent className="pt-6 flex flex-col items-center text-center">
                    ...
                    <Badge className="mt-2">Lecturer</Badge>
        ...
        <CardContent className="space-y-6">
            ...
            <div className="p-4 border rounded-md space-y-4">
                ...
                <div className="space-y-2">
                     ...
                     <div className="flex items-center justify-between">
                        <p className="text-sm text-muted-foreground">Receive email for assignment submissions.</p>
                        <Switch id="notification-submissions" defaultChecked />
                    </div>
                     <div className="flex items-center justify-between">
                        <p className="text-sm text-muted-foreground">Receive email for platform announcements.</p>
                        <Switch id="notification-announcements" defaultChecked />
                    </div>
                </div>
            </div>
        </CardContent>
